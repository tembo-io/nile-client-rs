...
pub async fn delete_policy(
    ...
    let local_var_uri_str = format!(
        ...
        workspace = crate::apis::urlencode(workspace),
        org = crate::apis::urlencode(org),
        policyId = crate::apis::urlencode(policy_id)
    );
    let mut local_var_req_builder =
...
pub async fn get_policy(
    ...
    org: &str,
    policy_id: &str,
) -> Result<crate::models::Policy, Error<GetPolicyError>> {
    let local_var_configuration = configuration;
...
pub async fn list_policies(
    ...
    workspace: &str,
    org: &str,
) -> Result<Vec<crate::models::Policy>, Error<ListPoliciesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::Policy, Error<UpdatePolicyError>> {
    let local_var_configuration = configuration;
