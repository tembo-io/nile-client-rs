...
pub async fn create_developer(
...
) -> Result<crate::models::User, Error<CreateDeveloperError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDeveloperError> =
...
pub async fn developer_google_o_auth_callback(
    configuration: &configuration::Configuration,
    code: Option<&str>,
    state: Option<&str>,
) -> Result<crate::models::DeveloperGoogleOAuthResponse, Error<DeveloperGoogleOAuthCallbackError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeveloperGoogleOAuthCallbackError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn login_developer(
...
) -> Result<crate::models::Token, Error<LoginDeveloperError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LoginDeveloperError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn start_developer_google_o_auth(
    configuration: &configuration::Configuration,
    redirect_to: Option<&str>,
) -> Result<(), Error<StartDeveloperGoogleOAuthError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = redirect_to {
        local_var_req_builder =
            local_var_req_builder.query(&[("redirect_to", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StartDeveloperGoogleOAuthError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn validate_developer(
    configuration: &configuration::Configuration,
    token: crate::models::Token,
) -> Result<(), Error<ValidateDeveloperError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ValidateDeveloperError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
